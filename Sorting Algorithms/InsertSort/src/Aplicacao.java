...
public class Aplicacao {
	...
	public static Jogo[] InsertSort(Jogo[] array, int n) {
		for (int i = 1; i < n; i++) {
			Jogo tmp = array[i];
	         	int j = i - 1;
	         	
		        while ((j >= 0) && (array[j].getAno() > tmp.getAno())) {
		        	array[j + 1] = array[j];
		            j--;
		            comparacao += 2;
		            troca++;
	         	}
		        while ((j >= 0) && (array[j].getAno() == tmp.getAno()) && (array[j].getMes() > tmp.getMes())) {
		        	array[j + 1] = array[j];
		            j--;
		            comparacao += 3;
		            troca++;
	         	}
		        while ((j >= 0) && (array[j].getAno() == tmp.getAno()) && (array[j].getMes() == tmp.getMes()) && (array[j].getDia() > tmp.getDia())) {
		        	array[j + 1] = array[j];
		            j--;
		            comparacao += 4;
		            troca++;
	         	}
		        while ((j >= 0) && (array[j].getAno() == tmp.getAno()) && (array[j].getMes() == tmp.getMes()) && (array[j].getDia() == tmp.getDia()) && (array[j].getSelecao1().compareTo(tmp.getSelecao1())) > 0) {
		        	array[j + 1] = array[j];
		            j--;
		            comparacao += 5;
		            troca++;
	...
	public static void main(String[] args) throws Exception {
		...
		ordenado = InsertSort(ordenado, tamanho);
		...
		escritor("1202168_insercao.txt", Integer.toString((int) tempoFinal), Integer.toString(comparacao), Integer.toString(troca));
