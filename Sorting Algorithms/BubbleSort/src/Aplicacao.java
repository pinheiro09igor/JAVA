...
public class Aplicacao {
	...
	public static Jogo[] BubbleSort(Jogo[] array, int n) {
		for (int i = (n - 1); i > 0; i--) {
			for (int j = 0; j < i; j++) {
				if (array[j].getDia() > array[j + 1].getDia()) {
				...
				}else if((array[j].getDia() == array[j + 1].getDia()) && (array[j].getMes() > array[j + 1].getMes())) {
				...
				}else if((array[j].getMes() == array[j + 1].getMes()) && (array[j].getAno() > array[j + 1].getAno())) {
				...
				}else if(((array[j].getAno() == array[j + 1].getAno())) && (array[j].getSelecao1().compareTo(array[j + 1].getSelecao1())) > 0) {     
	...
	public static void main(String[] args) throws Exception {
		...
		ordenado = BubbleSort(ordenado, tamanho);
		...
		escritor("1202168_bolha.txt", Integer.toString((int) tempoFinal), Integer.toString(comparacao), Integer.toString(troca));
