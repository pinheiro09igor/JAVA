...
public class Lista {
	...
	public void inserirInicio(Jogo novo) throws Exception {
		...
		Celula novaCelula, celulaAux;
				
			novaCelula = new Celula(novo);
			
			celulaAux = primeiro.getProximo();
			
			primeiro.setProximo(novaCelula);
			novaCelula.setProximo(celulaAux);
	...
	public Jogo removerFim() throws Exception {
		...
		Celula anterior, celulaRemovida;
	...
	public Jogo removerInicio() throws Exception {
		...
		Celula celulaRemovida, proximaCelula;
		
		if (! listaVazia()) {
				
				celulaRemovida = primeiro.getProximo();
				
				proximaCelula = celulaRemovida.getProximo();
				
				primeiro.setProximo(proximaCelula);
				celulaRemovida.setProximo(null);
